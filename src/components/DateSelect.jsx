  ...
  return (
    <div id="dateSelect" className="pt-20">
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 relative p-8 bg-primary/10 border border-primary/20 rounded-lg">
            ...
            <BlurCircle top="100px" right="-86px" />
            <div>
                ...
                <div className="flex items-center gap-6 text-sm mt-5">
                    ...
                    <ChevronRightCircle width={28}/>
                </div>
            </div>
            <button onClick={onBoolHandler} className="bg-primary text-white px-8 py-2 mt-6 rounded hover:bg-primary/90 transition-all cursor-pointer">
                Book Now
            </button>
        </div>
    </div>
